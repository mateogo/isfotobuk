...
public class HomeDestacadosView {
	...
	private List<ArticlePortlet> articulosDestacados;

	public HomeDestacadosView(){
		
	}
	public HomeDestacadosView(HttpServletRequest rq){
		setRequest(rq);
